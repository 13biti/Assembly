;************* teacher : Mr. Najafi ********************
;************* student : Ali Falahat *******************
;*********** student number : 400463158 ****************
;*** The final project of the microprocessor course ****
;**************** Description : ************************
;********* Hello . I tried to specify different ********
;********* parts of the program using comments. ********
;******************** thank you ***********************

;---!!!!!! this project build for >> linux << operatin systems .----------
;---!!!!!! use "nasm -g -f elf " to build object file --------------------
;---!!!!!! then "gcc -m32 -nostartfiles -g" to create executable file ----
